...
For example if the given number is 36, then the answer would be 6.

If the given number is 17, the answer would be 4 because sqrt(4) = 4.123105
whose floor value is 4.
